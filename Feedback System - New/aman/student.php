...
{
	$sqlpoint = "UPDATE point SET point_status='Approved', approval_date='$dttim' WHERE  entryid='$_GET[editid]'";
	$qsqlpoint = mysqli_query($con,$sqlpoint);
	if(mysqli_affected_rows($con) == 1)
	{
	//#####REGISTRATION VERIFICATION MAIL STARTS HERE
	$message = "Welcome $_POST[studentname],<br>Your Student Feedback System account  successfully activated. You can start using account...";
