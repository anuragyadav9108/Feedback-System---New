...
$entryid =$_SESSION['adminid'];
$adminid=$_SESSION['adminid'];
$studentid=0;
$user_type='Admin';
$module= 'Admin Account';
$submodule='Admin Profile';
$log_message = "Admin Profile updated successfully...";
$logdttim=$dttim;
$logsstatus="Active";
insertlogs($entryid,$adminid,$studentid,$user_type,$module,$submodule,$log_message,$logdttim,$logsstatus);
